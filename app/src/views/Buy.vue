<template>
    <div>
        <van-nav-bar :title="hot_name"  left-arrow >
        <template #left>
            <van-icon name="arrow-left" size="26" @click="gotoDetail(hot_id)" style="margin-right:5px;" />
        </template>
        <template #right>
        ...
        <van-tabs v-model="active">
            <van-tab title="今天11月20日"></van-tab>
            <van-tab title="明天11月21日"></van-tab>
            <van-tab title="后天11月22日"></van-tab>
            <van-tab title="周二11月23日"></van-tab>
        </van-tabs>
